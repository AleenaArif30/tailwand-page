      ...
      <div className='w-full bg-white flex items-center justify-center'>
        ...
        src={props.src}
            ...
            <div className='text-center'>
              ...
              <br />
              <div className='flex justify-center gap-4'>
                <button className='bg-black text-white px-4 py-3 text-sm rounded-lg hover:bg-green-600 transition'>
                  Get it on the app store
                </button>
                <button className='bg-blue-600 text-white border border-green-500 px-4 py-3 text-sm rounded-lg hover:bg-green-100 transition'>
